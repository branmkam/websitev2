...
<div>
  <title>Brandon Kaminski - Contact</title>
    <div class = "main">
      <img id = "headshot" src = {myheadshot} height = "400"></img>
      <br/>
      <h2>Experience</h2>
      <h3>Download my resume! <Link to="/files/ResumeBrandonKaminski.pdf" target="_blank" download>(.pdf)</Link> or <Link to="/files/ResumeBrandonKaminski.docx" target="_blank" download> (.docx)</Link> | <a href = "https://www.linkedin.com/in/brandon-kaminski/" target = "_blank">View my LinkedIn profile!</a></h3>
      <br/>
      <h2>About Me: Who Am I?</h2>
      <p>I recently finished my junior year at the University of North Carolina - Chapel Hill,
      ...
      other languages from friends who speak them or by using language learning software like Duolingo.</p>
         <p>To see my coding projects, click on the "My Projects" tab!</p>
    <br />
      <p></p>
   </div>
  </div>
